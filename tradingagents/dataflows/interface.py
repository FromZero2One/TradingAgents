...
from .mysql_provider import (
    get_stock as get_mysql_stock,
    get_indicators as get_mysql_indicators,
    get_fundamentals as get_mysql_fundamentals,
    get_news as get_mysql_news,
)
...
VENDOR_LIST = [
    "yfinance",
    "alpha_vantage",
    "akshare",  # Chinese market data provider
    "mysql",    # MySQL database (stable, pre-populated data)
]
...
VENDOR_METHODS = {
    ...
    "get_stock_data": {
        ...
        "mysql": get_mysql_stock,
    },
    # technical_indicators (now supports AKShare via pandas-ta, MySQL for stable OHLCV)
    "get_indicators": {
        "alpha_vantage": get_alpha_vantage_indicator,
        "yfinance": get_stock_stats_indicators_window,
        "akshare": get_akshare_indicators,
        "mysql": get_mysql_indicators,
    },
    # fundamental_data
    "get_fundamentals": {
